    ...
    return (
        <>
                ...
                <div className="container">
                    ...
                    <div className="sec QuienesSomos">
                        ...
                        <p>
                            ...
                            Nuestra misión es fomentar el desarrollo infantil a través de materiales educativos de alta calidad y diseños únicos que inspiran el aprendizaje y la creatividad.
                            En Cururu, cada pieza es creada con amor y dedicación, pensando en el bienestar y el crecimiento de los más pequeños.
            ...
            <div className="copyrightsec">
                <p>&copy; Agus - Patri. Todos los derechos reservados</p>
            </div>
            <FooterButton /> 
        </>
    );
